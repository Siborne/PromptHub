...
| ----- | ------------ | --------------- | -------------- | -------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| #184  | open         | local_done      |                | `cli-desktop-database-concurrency`           | WASM statements now release completed locks, live locks are never deleted blindly, CLI contention is typed, and Desktop refreshes on resume. Keep GitHub open until release. |
