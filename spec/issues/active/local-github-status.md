...
| #186  | open         | local_done   |                | `desktop-issue-186-zcode-agent-support`                             | Documented ZCode Skills, Rules, native MCP projection, and global/project presets are implemented and verified locally; Plugin distribution remains pending a confirmed local package contract.                    |
