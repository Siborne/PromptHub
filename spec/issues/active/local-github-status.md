...
| ----- | ------------ | --------------- | -------------- | ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| #183  | open         | release_pending | 0.5.9          | `skill-frontmatter-yaml-parser`                                    | Shared YAML parsing now covers Desktop, CLI, Web, marketplaces, and Skill detail surfaces; lossless rewrites, embedded indentation, and strict unsafe/malformed YAML rejection are verified and included in the replacement release. |
