...
- Registry commands do not edit Agent-native config, secrets, sessions, usage data, appearance state, executables, or package-manager state. Those capabilities require explicit reusable adapters outside Electron before they can be added to the standalone CLI.
