...
- [x] `T-PORT-001` Define the renderer bootstrap and E2E-profile boundary for `FR-PORT-001` / `DES-PORT-001`.
- [x] `T-PORT-002` Define portable Skill restore ownership for `FR-PORT-002` / `DES-PORT-002`.
- [x] `T-PORT-003` Move the app shell and E2E-only backup bridge behind dynamic imports without changing the language-ready mount contract.
