...
This document defines what “cover most CC Switch capabilities” means for PromptHub. It is a product capability comparison, not an instruction to copy CC Switch implementation or UI.

- Comparison date: 2026-07-15
- CC Switch documentation baseline: v3.16.0 documentation published in its official repository
...
| CLI install/update/diagnose | Managed CLI lifecycle                                                                 | PromptHub manages its own CLI but not all Agent CLIs                                                   | Adapter-specific detect/install/update/diagnose                                                                                                                   | Phase 2       |
