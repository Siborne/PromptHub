...
- [x] Add shared custom store source helpers and adapters.
- [x] Gate Skill custom source deletion behind a confirmation dialog.
- [x] Update Skill custom source tests from immediate deletion to confirmation-gated deletion.
