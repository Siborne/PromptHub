...
PromptHub へのスポンサーおよびモデルサービス支援を提供してくださる **Infistar.ai** に感謝します。

| パートナー                                                                       | モデルサービスと用途                                                                                                                                                                                                                                                                                                      | PromptHub ユーザー向け                                                                                                                                                                                                                                                                                                                       |
| :------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[Infistar.ai](https://www.infistar.cc/register?aff=RX9CVLVQ&ref_source=link)** | OpenAI 標準インターフェース互換のマルチモデル API を提供し、ChatGPT、Claude、Gemini、Kimi、GLM、DeepSeek などを Prompt テスト、AI 生成、翻訳・推敲、Skill ワークフロー、モデル比較に利用できます。スポンサーによると、高同時実行チャネルと複数ノードの冗長構成を備え、一部モデルは公式チャネルの約 10% から利用できます。 | **[アフィリエイトリンクから登録して現在の特典を確認](https://www.infistar.cc/register?aff=RX9CVLVQ&ref_source=link)**<br><sub>これはアフィリエイトリンクであり、条件を満たす登録や利用により PromptHub がプロモーション収益を得る場合があります。モデル、可用性、価格、クレジット、キャンペーン条件は Infistar.ai のページが基準です。</sub> |
...
| プレビュー       | [![現在のプレビュー](https://img.shields.io/badge/Preview-v0.6.0--beta.1-8B5CF6?style=for-the-badge&logo=github&logoColor=white)](https://github.com/legeling/PromptHub/releases/tag/v0.6.0-beta.1)                                                                                                                                                                                                                                     | [GitHub Prerelease v0.6.0-beta.1](https://github.com/legeling/PromptHub/releases/tag/v0.6.0-beta.1)                                                                                                                                                                                                                                                                                                                                     |
